...
template <typename T> struct Iterable<T, requires<conjunction<
  detail::has_begin<T>, detail::has_end<T>,
  detail::has_inc<detail::begin_result<T>>,
  detail::has_inc<detail::end_result<T>>,
  detail::has_deref<detail::begin_result<T>>,
  detail::has_deref<detail::end_result<T>>,
  std::is_same<detail::deref_result<detail::begin_result<T>>, detail::deref_result<detail::end_result<T>>>
>>> : std::true_type
{
};
...
struct Problem<
  T, requires<conjunction<
       ...
       has_evaluate<T>, std::is_same<double, evaluate_result<T>>,
       Iterable<recombine_result<T>>,
